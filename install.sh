mkdir ~/.local/share/plasma ~/.local/share/plasma/desktoptheme ~/.local/share/aurorae ~/.local/share/aurorae/themes/ ~/.local/share/color-schemes/ ~/.local/share/plasma/look-and-feel/
